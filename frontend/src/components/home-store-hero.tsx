...
const HERO_IMAGE =
  "/banners/saudi-offer-banner.png";
...
export function HomeStoreHero({
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-[0_22px_56px_-22px_rgba(76,29,10,0.28)] sm:rounded-3xl">
      ...
      <div className="grid gap-0 lg:grid-cols-[1fr] lg:items-stretch">
        <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10">
          ...
          >
            <MotionLink
              href="/shop"
              className="inline-flex min-h-[3rem] min-w-[200px] items-center justify-center rounded-xl bg-[var(--accent)] px-8 py-3 text-sm font-semibold text-white shadow-[0_12px_32px_-12px_rgba(180,83,9,0.45)] transition hover:bg-[var(--primary-to)]"
